...
// // 퍼플렉시티 API KEY
// const API_KEY_PPLX = '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';
// // 챗GPT API KEY
// const API_KEY_GPT = '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'

// function translateWithSelectedAI(){
//     translateLLM(aiTranslator);
// }

// // LLM을 이용한 번역 요청
// async function translateLLM(provider) {
//     const inputText = studyData[currStudyDataNum].script_foreign;
//     const outputDiv = document.getElementById('script_a_llm');
//     let response;

//     try {
//         showPopup(`${provider}로 번역합니다.`, 3000); // 하단에 gpt 번역 메시지 띄움. 
//         if(provider == "gpt") {
//             // 챗GPT API 호출
//             const API_KEY = API_KEY_GPT;
...
//                     // model: "gpt-3.5-turbo",
//                     messages: [
//                         {role: "system", content: "You are a helpful translator and a foreign language teacher. Translate the following foreign language text to Korean. 비속어, 숙어, 구동사, 어려운 단어가 있으면 한국어로 자세히 설명해줘."},
...
// // AI를 이용한 LLM 번역
// async function translateLLM_old() {
...
//             model: "gpt-3.5-turbo",
//             messages: [
//                 {role: "system", content: "You are a helpful translator. Translate the following English text to Korean. 꼭 한국어로 번역해줘. 일본어와 중국어는 사용하지 말아줘."},
//                 {role: "user", content: `Translate this: "${inputText}"`}
//             ]
//         })
//     });
